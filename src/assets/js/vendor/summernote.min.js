  ...
  return (function (t) {
    ...
    3: function (t, e, n) {
      ...
      i.a.summernote = i.a.extend(i.a.summernote, {
        ...
        options: {
          ...
          tableClassName: "table dk-border-oneed",
    ...
    51: function (t, e, n) {
      ...
      var h = (function () {
        ...
        A = function (t) {
          var e =
              '<div class="note-form-group"><label htmlFor="note-dialog-video-url-' +
              t.id +
              '" class="note-form-label">' +
              t.lang.video.url +
              ' <small class="text-muted">' +
        ...
        F = function (t) {
          var e =
              '<div class="note-form-group note-group-select-from-files"><label htmlFor="note-dialog-image-file-' +
              t.id +
              '" class="note-form-label">' +
              ...
              t.imageLimitation +
              '</div><div class="note-form-group"><label htmlFor="note-dialog-image-url-' +
              t.id +
              '" class="note-form-label">' +
              t.lang.image.url +
        ...
        D = function (t) {
          var e =
              '<div class="note-form-group"><label htmlFor="note-dialog-link-txt-' +
              t.id +
              '" class="note-form-label">' +
              t.lang.link.textToDisplay +
              '</label><input id="note-dialog-link-txt-' +
              t.id +
              '" class="note-link-text note-input" type="text"/></div><div class="note-form-group"><label htmlFor="note-dialog-link-url-' +
              t.id +
              '" class="note-form-label">' +
              t.lang.link.url +
              ...
              (t.disableLinkTarget
                ? ""
                : '<div class="checkbox"><label htmlFor="note-dialog-link-nw-' +
                  t.id +
                  ...
                  "</label></div>") +
              '<div class="checkbox"><label htmlFor="note-dialog-link-up-' +
              t.id +
