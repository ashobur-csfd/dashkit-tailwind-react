            ...
            <form action="#">
                <div className="grid grid-cols-12 gap-x-4">
                    ...
                    <div className="col-span-full lg:col-span-7 card">
                        <div className="p-1.5">
                            <h6 className="card-title">Edit This course</h6>
                            <div className="mt-7 pt-0.5">
                                <div className="grid grid-cols-2 gap-x-4 gap-y-5">
                                    <div className="col-span-full xl:col-auto leading-none">
                                        <Inputs basic labelId={'courseTitle'} labelText={'How about a course title'} placeholder={'Course Title'} className={'form-input'} type={'text'} defaultValue={course?.title} name="courseTitle" />
                                    </div>
                                    <div className="col-span-full xl:col-auto leading-none">
                                        <Inputs basic labelId={'coursePrice'} labelText={'Course price'} placeholder={'$200.00'} className={'form-input'} type={'number'} defaultValue={course?.price} name="coursePrice" />
                                    </div>
                                    <div className="col-span-full xl:col-auto leading-none">
                                    ...
                                    <div className="col-span-full xl:col-auto leading-none">
                                        <Inputs basic labelId={'courseInstructor'} labelText={'Instructor'} placeholder={'Jhone Doe'} className={'form-input'} type={'text'} defaultValue={course?.instructor} name="courseInstructor" />
                                    </div>
                                    <div className="col-span-full xl:col-auto leading-none">
                                    ...
                                    <div className="col-span-full xl:col-auto leading-none">
                                        <Inputs basic labelId={'courseDuration'} labelText={'Course duration'} placeholder={'2h 30m'} className={'form-input'} type={'text'} defaultValue={course?.duration} name="courseDuration" />
                                    </div>
                                    <div className="col-span-full xl:col-auto leading-none">
                                    ...
                                    <div className="col-span-full">
                                        ...
                                        <textarea id="description" rows="8" className="summernote form-input !h-[200px]">
                                            {course?.description}
                                        </textarea>
