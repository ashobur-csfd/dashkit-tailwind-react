                    ...
                    <div className="border border-form dark:border-dark-border p-5 md:p-10 rounded-20 md:rounded-30">
                        ...
                        <form action="index.html" className="leading-none mt-8">
                            ...
                            <div className="flex items-center justify-between mt-3 mb-7">
                                ...
                                <a href="forgot-password.html" className="text-xs leading-none text-primary-500 font-semibold">Forgot password?</a>
                            </div>
                            {/* Submit Button */}
                            <Button type='submit' text={'Sign In'} className="btn b-solid btn-primary-solid w-full"/>
                        </form>
                        ...
                        <div className="text-gray-900 dark:text-dark-text font-medium leading-none mt-5">
                            ...
                            <Button link={'sign-up'} text={' Sign Up'} className="text-primary-500 font-semibold"/>
                        </div>
                    </div>
                </div>
                {/* End Form Area */}
